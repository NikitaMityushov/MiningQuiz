...
import com.mityushovn.miningquiz.quizlist_feature.databinding.ExamsFragmentBinding
...
internal class ExamsFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        // configure DI
        (parentFragment as com.mityushovn.miningquiz.quizlist_feature.api.QuizListFragment).component.injectInExamsFragment(this)
    }

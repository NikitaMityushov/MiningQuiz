...
import com.mityushovn.quizlist_feature.api.QuizListFragment
import com.mityushovn.quizlist_feature.databinding.ExamsFragmentBinding
import com.mityushovn.quizlist_feature.internal.navigation.Navigator
import com.mityushovn.quizlist_feature.internal.presentation.examsfragment.recyclerview.ExamsFrListAdapter
...
internal class ExamsFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        // configure DI
        (parentFragment as QuizListFragment).component.injectInExamsFragment(this)
    }
